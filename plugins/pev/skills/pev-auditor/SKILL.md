...
Follow `cortex::docs.templates.auditor-reference-protocol` for the full checklist. The key sections in order:
...
- **Follow the Auditor Reference Protocol** (`cortex::docs.templates.auditor-reference-protocol`) for the full checklist. The protocol sections are ordered — follow them in order.
