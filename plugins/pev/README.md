...
- [cortex](https://github.com/ddpoe/cortex) MCP installed and configured in your project — PEV uses it for codebase reads, doc graph, and cycle manifest persistence
